...
const Report = ({report}) => {
    const [personalDetails, setPersonaslDetails] = useState({
        name: '',
        age: '',
        stressLevel: '',
        history: ''
...
// const prompt = `Generate a hairfall report based on the following information:
// Stress Level: ${stressLevel}
// Family History: ${familyHistory}
// File Content: ${fileContent}

//   The response should contain follwing parameters:
//       1) Baldness Stage:
//       2) Hair Density:
//       3) Scalp Condition:
//       4) Risk Factor:
