...
const badges = [
    ...
    },
    {
        ...
        text: 'Online Test',
        className: 'absolute top-10 left-10 lg:top-[600px] lg:-left-20 z-10'
    },
    {
        id: uuidv4(),
        icon: <FaCheckCircle className='w-[20px] h-[20px] text-green-600'/>,
        text: 'Trusted Results',
        className: 'absolute top-10 left-10 xl:top-[350px] xl:left-[400px] lg:top-[350px] lg:left-[350px] z-10'
    },
]
